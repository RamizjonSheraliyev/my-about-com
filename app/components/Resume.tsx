    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="relative border-l-4 border-gray-500 pl-6 space-y-4">
          {[{ title: "Full-Stack Web Development", date: "2022-2025", description: "Full-stack sayt yaratish: frontend va backend tizimlarini birlashtirish. JavaScript, React.js va Next.js yordamida saytni toliq rivojlantirish. Server va backend tizimlar bilan integratsiya qilish va Senior daraja frontend qismini organib tajriba orttirdim" },
          ...
          { title: "Full-Stack Course", date: "2023", description: "Full-stack dasturlash bo'yicha amaliyot qilib ishlaganman." }
          ].map((item, index) => (
            ...
            <div key={index} className="mb-4">
              <div className="flex justify-between">
                ...
                <span className="text-lg font-medium">
                  {[90, 80, 90, 90, 100, 90, 100][index]}%
                </span>
              </div>
              <div className="w-full bg-gray-300 rounded-full h-2.5 dark:bg-gray-700">
                <div
                  className="bg-yellow-500 h-2.5 rounded-full"
                  style={{ width: `${[90, 80, 90, 90, 100, 90, 100][index]}%` }}
                ></div>
              </div>
            </div>
          ))}
